...
All codes were performed in Python (version 3.12.12). There are ### code files, which were used for mathematical calculation and model fitting, Stochastic simulation, visualizing figures.
